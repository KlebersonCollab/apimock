...
|---|---|---|---|---|---|---|
| [ ] | TASK-01 | feat | Initialize Go module and implement domain models with validation tests | `go.mod`, `pkg/models/models.go`, `pkg/models/models_test.go` | None | Pending |
